...
var require_createVariable_native = __commonJS({
  "../web/dist/cjs/createVariable.native.js"(exports2, module2) {
    ...
    var IS_VAR = "isVar", createVariable = function(props) {
      ...
      return _obj = {}, _define_property2(_obj, IS_VAR, !0), _define_property2(_obj, "key", key), _define_property2(_obj, "name", skipHash ? "" : (0, import_helpers.simpleHash)(name, 40)), _define_property2(_obj, "val", val), _define_property2(_obj, "variable", import_constants.isWeb ? skipHash ? "var(--".concat(name, ")") : createCSSVariable(name) : ""), _obj;
    };
...
var require_Text_native = __commonJS({
  "../web/dist/cjs/views/Text.native.js"(exports2, module2) {
    ...
    var ellipsisStyle = {
      ...
      variants: _object_spread_props(_object_spread2(_object_spread_props(_object_spread2({}, !1), {
        // ??
        ellipsizeMode: {
          "...": function() {
            return null;
