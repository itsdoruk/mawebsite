...
current`, {
  ...
  if (props.style) if (isHOC) viewProps.style = props.style;else for (const style of [].concat(props.style)) style && (style.$$css ? Object.assign(styleState.classNames, style) : (styleState.style ||= {}, Object.assign(styleState.style, style)));
